...
const Footer = () => {
  return (
    <>
        <div className='   mt-5 p-3   flex items-start justify-evenly   h-96 w-240   '>
            <div className='   h-full w-md pl-8 pt-8   '>
                            <img src="/bidfordeal.png" alt="logo" className='h-20 w-55 font-stretch-100% flex items-center justify-center' />
